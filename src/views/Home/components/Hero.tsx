      ...
      >
        <Flex flex="1" flexDirection="column">
          <Heading scale="xl" color="primary" mb="24px">
            {t("PancakeSwap auto rewards to boost yields")}
          </Heading>
          <Text mb="20px" fontSize="18px">
            {t('The PancakeSwap protocol adds incentives to earning crypto safely and securely for Notch network participants by introducing revenue sharing through the classic AMM model. We provide a platform for trading, staking, and farming.')}
          </Text>
          ...
          <Flex>
            ...
            <Link mr="16px" href="https://cultcroswap.com/#/swap">
